...
import {
  ...
  getJumlahLuasGudangPerbulanfasilitator,
  getJumlahPekerjaPerbulan,
  getJumlahPekerjaPerbulanfasilitator,
  getPembelianSemuaMitraPerbulan,
  getPembelianSemuaMitraPerbulanfasilitator,
  getPembelianPermitraPerbulan,
  getPembelianPermitraPerbulanline,
  getPembelianPermitraPerbulanlinefas,
  getPembelianPermitraPerbulanlinevsmitra,
  getPembelianPermitraPerbulanlinevsmitrafasilitator,
  getPenjualanPermitraPerbulanlinevsmitra,
  getPenjualanPermitraPerbulanlinevsmitrafasilitator,
  getPenjualantotalmitravspembelian,
  getPenjualantotalmitravspembelianfasilitator,
  getpembeliantotalmitravspembelian,
  getpembeliantotalmitravspembelianfasilitator,
  getPenjualanPermitraPerbulan,
  getPenjualanPermitraPerbulanline,
  getPenjualanPermitraPerbulanlinefasilitat,
  getpermitraPerbulanlinecontinue,
  getpermitraPerbulanlinecontinuefasilitator,
  getpembelianpermitraPerbulanlinecontinue,
  getpembelianpermitraPerbulanlinecontinuefasilitator,
  getPenjualanSemuaMitraPerbulan,
  getPenjualanSemuaMitraPerbulanfasilitator,
  ...
  getMasalahSemuaMitraPerbulanPerjenisPerstatusLine,
  getMasalahSemuaMitraPerbulanPerjenisPerstatusLinefas,
  getMasalahPermitraPerbulanPerjenisPerstatus,
  getPenjualanPerkategori,
  getPembelianPerkategori,
  getPembelianPerkategorifas,
